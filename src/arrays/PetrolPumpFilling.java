 ...
 */
/*
 * <pre> There are N gas stations along a circular route, where the amount of
 ...
 * Therefore, return 3 as the starting index. </pre>
 */
public class PetrolPumpFilling {
	...
	public static void main(String[] args) {
		...
		solution(petrols, distance);

	}

	private static void solution(int[] petrols, int[] distance) {
		// Let's create a diff array
