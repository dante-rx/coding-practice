 ...
 */
/**
 * https://leetcode.com/problems/decode-ways/ A message containing letters from
...
public class DecodeWays {
	...
	/**
	 * Approach check if subString(n-2, n) is a valid string or not. <br>
	 * Check if subString(n-1, n) is a valid string or not <br>
	 * solution[0] = 1; because a solution can be formed with empty string
	 * 
	 * @param str
	 * @return
	 */
